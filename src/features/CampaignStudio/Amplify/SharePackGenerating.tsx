        ...
        <section className="cs-wizard-section cs-details-step">
          <div className="cs-generation__progress amp-generation__progress" aria-live="polite">
            ...
            <div className="cs-skeleton-grid amp-generation__skeletons">
              <div className="cs-skeleton-card amp-generation__skeleton amp-generation__skeleton--media" />
              <div className="amp-generation__skeleton-lines" aria-hidden="true">
                <span className="amp-generation__skeleton-line" />
                <span className="amp-generation__skeleton-line" />
                <span className="amp-generation__skeleton-line" />
                <span className="amp-generation__skeleton-line" />
                <span className="amp-generation__skeleton-line" />
