        ...
        {launched ? (
          ...
          <div className="cb-drawer__body">
            <label className="cb-drawer__field">
              ...
              <UiDropdown
                value={template}
                options={templateOptions.map((option) => ({ value: option, label: option }))}
            ...
            <section className="cb-vh-list">
              ...
              <div className="cb-recipient-quick">
                <UiDropdown
                  ...
                  ariaLabel="Add department team"
                  options={[
                    { value: "", label: "Add a department…" },
                    ...departmentOptions.map((department) => ({
                      value: department,
                      label: `${department} (${employeeDirectory.filter((person) => person.department === department).length})`,
                    })),
                  ]}
                  onChange={(value) => {
